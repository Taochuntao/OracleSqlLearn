...
/* Comments for your marker:
	Create the 3 missing table in initial script, 
	visit, cisit_service and visit_drug
	Add primary key and unique key constraint first
...
COMMENT ON COLUMN visit.visit_length IS
    'Visit length in minutes (must be between 30 - 90 minutes,
inclusive)';
...
ALTER TABLE visit ADD CONSTRAINT visit_uk UNIQUE ( visit_date_time, animal_id  );
